...
class BreastfeedingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breastfeeding" do
    assert_difference('Breastfeeding.count') do
      post breastfeedings_url, params: { breastfeeding: { feeding_quantity: @breastfeeding.feeding_quantity, feeding_time: @breastfeeding.feeding_time } }
    end
  ...
  test "should update breastfeeding" do
    patch breastfeeding_url(@breastfeeding), params: { breastfeeding: { feeding_quantity: @breastfeeding.feeding_quantity, feeding_time: @breastfeeding.feeding_time } }
